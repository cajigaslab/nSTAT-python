...
| Example 08 | ![Example 08](docs/figures/example08/fig01_real_place_fields_panel.png) | Does a B-spline Poisson GLM trained on real hippocampal place cells produce a held-out spatial pair-correlation inside the inhomogeneous global-rank envelope, and a population rescaled-time ACF inside the Bartlett band? | `python examples/paper/example08_real_place_cells.py` | [Script](examples/paper/example08_real_place_cells.py) · [Figures](docs/figures/example08/) |
