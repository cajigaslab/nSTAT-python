...
# v0.3.1 module split.  We re-export it here so all legacy import paths
# (``from nstat.core import nspikeTrain``, ``from nstat.nspikeTrain import
# nspikeTrain``, ``from nstat import nspikeTrain``) continue to work.
from ._spike_train_impl import nspikeTrain  # noqa: E402
