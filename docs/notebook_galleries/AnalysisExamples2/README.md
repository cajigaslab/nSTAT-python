# AnalysisExamples2 — figure gallery

This page is the rendered figure output of
[`notebooks/AnalysisExamples2.ipynb`](../../notebooks/AnalysisExamples2.ipynb).
...
- Source notebook: [`notebooks/AnalysisExamples2.ipynb`](../../notebooks/AnalysisExamples2.ipynb)
- Figures: 6 (4 with substantive plot content)
