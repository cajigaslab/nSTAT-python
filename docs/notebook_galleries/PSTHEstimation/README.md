# PSTHEstimation — figure gallery

This page is the rendered figure output of
[`notebooks/PSTHEstimation.ipynb`](../../notebooks/PSTHEstimation.ipynb).
...
- Source notebook: [`notebooks/PSTHEstimation.ipynb`](../../notebooks/PSTHEstimation.ipynb)
