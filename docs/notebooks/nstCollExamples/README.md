# nstCollExamples — figure gallery

This page is the rendered figure output of
[`notebooks/nstCollExamples.ipynb`](../../notebooks/nstCollExamples.ipynb).
...
- Source notebook: [`notebooks/nstCollExamples.ipynb`](../../notebooks/nstCollExamples.ipynb)
- Figures: 3 (1 with substantive plot content)
