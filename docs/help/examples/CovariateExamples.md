...
Python-native tutorial page for `CovariateExamples`.

## Notebook
- [CovariateExamples.ipynb](https://github.com/cajigaslab/nSTAT-python/blob/main/notebooks/CovariateExamples.ipynb)
