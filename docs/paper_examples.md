...
- `docs/figures/example08/fig09_coupling_matrix.png`
- `docs/figures/example08/fig10_decoder_baseline_vs_progression.png`
- `docs/figures/example08/fig11_per_cell_lag_ccf.png`
- `docs/figures/example08/fig12_lag_corrected_comparison.png`
