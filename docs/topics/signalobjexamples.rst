...
Example Utility
---------------
This example demonstrates how `SignalObj` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/SignalObjExamples.mlx``
MATLAB Live Script title: ``Using the SignalObj Class``
...
-----------------------------
Signal representations used as building blocks for CIF modeling workflows.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/SignalObjExamples.ipynb``.
