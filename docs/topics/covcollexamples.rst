...
.. list-table::
   ...
   * - MATLAB API
     - Python API
   * - ``CovColl``
     - ``nstat.trial.CovariateCollection``
...
Example Utility
---------------
This example demonstrates how `CovColl` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/CovCollExamples.mlx``
MATLAB Live Script title: ``Test CovColl``
...
-----------------------------
Assembling aligned covariates into matrix form for model fitting.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/CovCollExamples.ipynb``.
