...
Example Utility
---------------
This example demonstrates how `Covariate` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/CovariateExamples.mlx``
MATLAB Live Script title: ``Test the Cov class``
...
-----------------------------
Construction and manipulation of stimulus/history covariates used by PP-GLM models.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/CovariateExamples.ipynb``.
