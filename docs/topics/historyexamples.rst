...
Example Utility
---------------
This example demonstrates how `History` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/HistoryExamples.mlx``
MATLAB Live Script title: ``Test History``
...
-----------------------------
History basis construction for refractory and post-spike dependence effects.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/HistoryExamples.ipynb``.
