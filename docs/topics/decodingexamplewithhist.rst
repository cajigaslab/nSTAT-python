...
Example Utility
---------------
This example demonstrates how `DecodingExampleWithHist` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/DecodingExampleWithHist.mlx``
MATLAB Live Script title: ``1-D Stimulus Decode with History Effect``
...
-----------------------------
Comparison of decoding performance with and without spike-history effects.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/DecodingExampleWithHist.ipynb``.
