...
Example Utility
---------------
This example demonstrates how `ConfigColl` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/ConfigCollExamples.mlx``
MATLAB Live Script title: ``ConfigColl Examples``
...
-----------------------------
Managing competing model configurations for AIC/BIC-based comparison.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/ConfigCollExamples.ipynb``.
