...
Example Utility
---------------
This example demonstrates how `FitResult` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/FitResultExamples.mlx``
MATLAB Live Script title: ``FitResult Examples``
...
-----------------------------
Inspection of fitted model parameters and diagnostics at single-neuron level.
