...
.. list-table::
   ...
   * - MATLAB API
     - Python API
   * - ``nstColl``
     - ``nstat.spikes.SpikeTrainCollection``
...
Example Utility
---------------
This example demonstrates how `nstColl` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/nstCollExamples.mlx``
MATLAB Live Script title: ``nstCollExamples``
...
- spike train collection
- population activity

Section-aligned Interpretation
-----------------------------
Population-level spike train handling and PSTH-style summaries.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/nstCollExamples.ipynb``.
