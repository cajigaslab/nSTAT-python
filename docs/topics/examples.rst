...
Example Utility
---------------
This example demonstrates how `Examples` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/Examples.mlx``
MATLAB Live Script title: ``Examples``
Paper Section Alignment
-----------------------
- Section 2.2.1 (Class descriptions)
