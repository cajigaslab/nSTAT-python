...
Example Utility
---------------
This example demonstrates how `FitResSummary` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/FitResSummaryExamples.mlx``
MATLAB Live Script title: ``FitResSummary Examples``
...
-----------------------------
Aggregated model-comparison summaries across fitted analyses.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/FitResSummaryExamples.ipynb``.
