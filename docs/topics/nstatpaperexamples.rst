...
Example Utility
---------------
This example demonstrates how `nSTATPaper` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/nSTATPaperExamples.mlx``
MATLAB Live Script title: ``nSTAT J. Neuroscience Methods Paper Examples``
...
-----------------------------
Compact replay of representative workflows reported in the paper.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/nSTATPaperExamples.ipynb``.
