...
Example Utility
---------------
This example demonstrates how `PPSimExample` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/PPSimExample.mlx``
MATLAB Live Script title: ``General Point Process Simulation``
...
-----------------------------
Simulated explicit stimulus/history effects for controlled CIF model validation.
