...
Example Utility
---------------
This example demonstrates how `Trial` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/TrialExamples.mlx``
MATLAB Live Script title: ``Trial Examples``
...
-----------------------------
Trial-level integration of spikes and covariates for fitting workflows.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/TrialExamples.ipynb``.
