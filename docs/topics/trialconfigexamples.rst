...
Example Utility
---------------
This example demonstrates how `TrialConfig` workflows map to standalone Python execution and why the resulting outputs are useful for model debugging and interpretation.
...
--------------------
Reference Live Script: ``nSTAT_currentRelease_Local/helpfiles/TrialConfigExamples.mlx``
MATLAB Live Script title: ``TrialConfig Examples``
...
-----------------------------
Configuration of covariate masks and sampling assumptions used during fitting.

Notebook
--------
A generated executable notebook is available at ``notebooks/helpfiles/TrialConfigExamples.ipynb``.
