...
def run(repo_root=None, figure_dir=None, render_figures=False):
    ...
    return run_topic("CovCollExamples", repo_root=repo_root, figure_dir=figure_dir, render_figures=render_figures)
...
def main() -> int:
    ...
    return _main("CovCollExamples", repo_root=args.repo_root, figure_dir=args.figure_dir, render_figures=args.render_figures)
